...
import { getSpecificTrendingMovies } from "../../api/SpecificMovie";
import { useQuery } from "@tanstack/react-query";
import MovieCard from "../Card/MovieCard";
import { CiCircleChevLeft } from "react-icons/ci";
import { CiCircleChevRight } from "react-icons/ci";

function SpecificTrendingMovie() {
  const slideIconStyle = "text-white text-4xl hover:text-gray-400 transition";
  const trendingMovieQuery = useQuery({
    queryKey: ["specifictrendingmovie"],
    queryFn: getSpecificTrendingMovies,
...
export default SpecificTrendingMovie;
